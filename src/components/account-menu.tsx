...
export default function AccountMenu() {
  ...
  const { mutateAsync: signOutFn, isPending: isSinningOut } = useMutation({
    mutationFn: signOut,
    onSuccess: () => {
    ...
    <Dialog>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-56">
          ...
          <DropdownMenuItem asChild className="text-orange-500 dark:text-orange-400" disabled={isSinningOut}>
