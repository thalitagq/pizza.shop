...
const data = [
  ...
  { date: '11/12', revenue: 203},
  { date: '12/12', revenue: 492},
  { date: '13/12', revenue: 1231},
  { date: '14/12', revenue: 783},
  { date: '15/12', revenue: 392},
  { date: '16/12', revenue: 402},
]
      ...
      <CardContent>
        <ResponsiveContainer width="100%" height={240}>
          <LineChart data={data} style={{ fontSize: 12}}>
            ...
            <Line type='linear' strokeWidth={2} dataKey="revenue" stroke={colors['teal']['500']}/>
          </LineChart>
        </ResponsiveContainer>  
      </CardContent>
    </Card>
